...
namespace Stealth.Common.Natives
{
    public static class Peds
    {
        ...
        {
            Rage.Native.NativeFunction.Natives.SET_PED_IS_DRUNK(pPed, pValue);
        }

        public static void AttackPed(Ped pPed, Ped pTargetPed)
        {
            Rage.Native.NativeFunction.Natives.TASK_COMBAT_PED(pPed, pTargetPed, 0, 1);
        }

        public static void ReactAndFleePed(Ped pPed, Ped pTargetPed)
        {
            // TASK_REACT_AND_FLEE_PED
            Rage.Native.NativeFunction.Natives.x72C896464915D1B1(pPed, pTargetPed);
        }

        public static void AimGunAtEntity(Ped pPed, Entity pTarget, int timeout)
        {
            // AI::TASK_AIM_GUN_AT_ENTITY
            Rage.Native.NativeFunction.Natives.x9B53BB6E8943AF53(pPed, pTarget, timeout, true);
        }

        public static void AimGunAtPosition(Ped pPed, Vector3 pTarget, int time)
        {
            // AI::TASK_AIM_GUN_AT_COORD
            Rage.Native.NativeFunction.Natives.x6671F3EEC681BDA1(pPed, pTarget.X, pTarget.Y, pTarget.Z, time, true, true);
        }

        public static void ShootAtPosition(Ped pPed, Vector3 pTarget)
        {
            // AI::TASK_SHOOT_AT_COORD
            Rage.Native.NativeFunction.Natives.x46A6CC01E0826106(pPed, pTarget.X, pTarget.Y, pTarget.Z, 0, 1);
        }

        public static void TurnToFaceEntity(Ped pPed, Entity pTarget, int timeout)
        {
            // AI::TASK_TURN_PED_TO_FACE_ENTITY
            Rage.Native.NativeFunction.Natives.x5AD23D40115353AC(pPed, pTarget, timeout, true);
        }
        ...
        public static void GoToEntityAiming(Ped pPed, Entity pTarget, float distanceToStopAt, float StartAimingDist)
        {
            ...
            Rage.Native.NativeFunction.Natives.xA9DA48FAB8A76C12(pPed, pTarget, distanceToStopAt, StartAimingDist);
        }
        ...
        {
            Rage.Native.NativeFunction.Natives.xFC545A9F0626E3B6(pDriver, pVehicle, pTarget, pDrivingStyle, pSpeed, pMinDistance);
        }
        ...
        {
            Rage.Native.NativeFunction.Natives.x0FA6E4B75F302400(pDriver, pVehicle, pTarget, p3, pSpeed, pDrivingStyle, pMinDistance, p7, pNoRoadsDistance);
        }

        public static void ChaseEntityInVehicle(Ped pDriver, Entity pTarget)
        {
            Rage.Native.NativeFunction.Natives.x3C08A8E30363B353(pDriver, pTarget);
        }
    }
}